...
` + cTable.getTable(rows));
    ...
    viewAllEmployeesByManager() {
        ...
        .then( ([rows,fields]) => {
            ...
            // ad a selection for no manager and set it's value to null
    ...
    // view total budget
    viewTotalBudget() {
        // shows total budgets, but throws an error when closing the application
        // this.displayQuery(crud.findDepartmentTotals); 
